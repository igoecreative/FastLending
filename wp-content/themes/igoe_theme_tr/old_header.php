...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$igoe_theme_tr_description = get_bloginfo( 'description', 'display' );
			if ( $igoe_theme_tr_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $igoe_theme_tr_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
